...
import { Download, Smartphone, AwardIcon as SafariIcon, Chrome } from "lucide-react"
...
export const GoUmrahLanding = () => {
  ...
  const showInstallButton = useMemo(() => isInstallable && !isIOS, [isInstallable, isIOS])
                  ...
                  {isIOS ? (
                    <div className="space-y-4 text-left">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-medium text-[#212529]">For Safari users:</h4>
                    ...
                    <div className="space-y-4 text-left">
                      <div className="flex items-start space-x-3">
                        <Chrome className="w-5 h-5 text-[#43aa8b] mt-1 flex-shrink-0" />
                        <div>
                          <h4 className="font-medium text-[#212529]">Install instructions:</h4>
                          <ol className="mt-2 space-y-2 text-sm text-[#577590] list-decimal list-inside">
                            <li>Open this page in Chrome or Edge browser</li>
                            <li>Look for the install icon in the address bar</li>
                            <li>Click "Install" to add GoUmrah to your device</li>
                          </ol>
                        </div>
                      </div>
                    </div>
